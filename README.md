...
### Admin Portal
- **Admin Registration** — Self-register a new admin account from the login page, then log in
...
| PUT    | /employee/update_profile/:id | Update phone/address, optionally photo |
